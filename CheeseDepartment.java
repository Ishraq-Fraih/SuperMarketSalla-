...
public class CheeseDepartment extends ProductCategories
{
   String companyName;
    
    CheeseDepartment(String name,String companyName,int quantity,double regularPrice,int productionYear,int completionYear)
